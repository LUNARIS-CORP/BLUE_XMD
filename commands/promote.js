...
async function promoteCommand(sock, chatId, mentionedJids, message) {
  ...
  if (userToPromote.length === 0) {
    await sock.sendMessage(chatId, {
      text: "Veuillez mentionner l'utilisateur ou r\xE9pondre \xE0 son message pour le promouvoir\xA0!"
    });
    return;
  }
  ...
  try {
    ...
    await sock.sendMessage(chatId, { text: "\xC9chec de la promotion des utilisateurs\xA0!" });
  }
}
