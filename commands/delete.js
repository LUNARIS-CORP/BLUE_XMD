...
async function deleteCommand(sock, chatId, message, senderId) {
  try {
    ...
    if (!isBotAdmin) {
      await sock.sendMessage(chatId, { text: "Je dois \xEAtre administrateur pour supprimer des messages." }, { quoted: message });
      return;
    }
    ...
    // If no number provided and not replying/mentioning, show usage message
      ...
      await sock.sendMessage(chatId, {
        text: "\u274C Merci de pr\xE9ciser le nombre de messages \xE0 supprimer. Utilisation\xA0: \u2022 `.del 5` - Supprimer les 5 derniers messages du groupe \u2022 `.del 3 @user` - Supprime les 3 derniers messages de @user \u2022 `.del 2` (r\xE9ponse au message) - Supprime les 2 derniers messages de l'utilisateur ayant r\xE9pondu"
      }, { quoted: message });
      return;
    }
    ...
    await sock.sendMessage(chatId, { text: "\xC9chec de la suppression des messages." }, { quoted: message });
  }
}
