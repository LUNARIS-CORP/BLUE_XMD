    ...
    if (args.length > 0) {
      ...
      if (isValidUrl(url)) {
        ...
        return sock.sendMessage(chatId, {
          text: "\u274C URL fournie non valide. Utilisation\xA0: `.remini https://example.com/image.jpg`"
        }, { quoted: message });
      }
    } else {
      ...
      if (!imageUrl) {
        return sock.sendMessage(chatId, {
          text: "\uD83D\uDCF8 *Commande d'am\xE9lioration de l'IA Remini* Utilisation\xA0: \u2022 `.remini <image_url>` \u2022 R\xE9pondre \xE0 une image avec `.remini` \u2022 Envoyer une image avec `.remini` Exemple\xA0: `.remini https://example.com/image.jpg`"
        }, { quoted: message });
      }
    }
      ...
      if (result.image_url) {
        ...
        if (imageResponse.status === 200 && imageResponse.data) {
          ...
          await sock.sendMessage(chatId, {
            ...
            caption: "\u2728 *Image am\xE9lior\xE9e avec succ\xE8s !* \uD835\uDDD8\uD835\uDDE1\uD835\uDDDB\uD835\uDDD4\uD835\uDDE1\uD835\uDDD6\uD835\uDDD8\uD835\uDDD7 \uD835\uDDD5\uD835\uDDEC \uD835\uDDDE\uD835\uDDE1\uD835\uDDDC\uD835\uDDDA\uD835\uDDDB\uD835\uDDE7-\uD835\uDDD5\uD835\uDDE2\uD835\uDDE7"
          }, { quoted: message });
        } else {
