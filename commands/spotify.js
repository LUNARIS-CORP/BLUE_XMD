...
async function spotifyCommand(sock, chatId, message) {
  try {
    ...
    if (!query) {
      await sock.sendMessage(chatId, { text: "Utilisation\xA0: .spotify <chanson/artiste/mots-cl\xE9s> Exemple\xA0: .spotify avec calme" }, { quoted: message });
      return;
    }
    ...
    if (!audioUrl) {
      await sock.sendMessage(chatId, { text: "Aucun audio t\xE9l\xE9chargeable trouv\xE9 pour cette requ\xEAte." }, { quoted: message });
      return;
    }
    ...
    await sock.sendMessage(chatId, { text: "\xC9chec de la r\xE9cup\xE9ration de l'audio Spotify. Essayez une autre requ\xEAte plus tard." }, { quoted: message });
  }
}
